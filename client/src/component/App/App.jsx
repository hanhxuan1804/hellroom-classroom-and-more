...
import { CreatePresentationPage, EditPresentationPage, ShowPresentationPage, PresentationsPage, ViewPresentationPage } from "../../pages/presentation";
    ...
    <Routes>
      ...
      <Route element={<ProtectedLayout />}>
        ...
        <Route path="presentation" element={<Outlet/>} >
          ...
          <Route path=":presentationCode/view" element={<ViewPresentationPage/>} />
